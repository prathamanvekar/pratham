...
const Gaze = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-gaze`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">python / opencv / haar cascades / lbph / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/image-personalizer"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/image-personalizer</span>
        ...
        >
          a webcam-validated facial recognition system with automated dataset management.
        </motion.p>
        ...
        >
          <p>built a webcam-validated python and opencv facial recognition system featuring automated dataset management, image preprocessing, and time-stamped training versioning using haar cascades and lbph.</p>
          <p>it implements haar cascade classifiers for robust face localization and local binary patterns histograms (lbph) for face identification.</p>
          <p>the system features automated dataset management, taking snapshots from webcams to dynamically preprocess and retrain models with time-stamped version control.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">recognition pipeline workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">feature detection</span>
              </div>

              {/* Step 2: Detection */}
              <div className="flex flex-row flex-nowrap items-center gap-2 md:gap-3 whitespace-nowrap">
                <div className="px-2.5 py-1.5 rounded border border-border/30 bg-white/[0.01] text-muted/60">
                  [haar cascades face check]
                </div>
              </div>
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">model evaluation</span>
              </div>
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">telemetry logger</span>
              </div>
