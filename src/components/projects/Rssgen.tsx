...
const Rssgen = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-rssgen`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">python / markdown / html / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/static-site-gen"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/static-site-gen</span>
        ...
        >
          a custom markdown-to-html conversion engine for generating static websites.
        </motion.p>
        ...
        >
          <p>developed a custom markdown-to-html conversion engine that parses inline and block markdown nodes to automatically generate fully formatted static websites.</p>
          <p>it features a custom parser that reads and tokenizes inline markdown elements (bold, italic, links) and block nodes (headings, code blocks, paragraphs).</p>
          <p>the engine compiles pages using static templates, enabling fast, dependency-free deployment of developer portfolios and blogs.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">compiler static site workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">parsing phase</span>
              </div>

              {/* Step 2: AST & Compiling */}
              <div className="flex flex-row flex-nowrap items-center gap-2 md:gap-3 whitespace-nowrap">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">generation output</span>
              </div>
