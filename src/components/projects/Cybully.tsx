...
const Cybully = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-cybully`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">python / flask / javascript / sqlite / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/cyberbul-realtime-ai"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/cyberbul-realtime-ai</span>
        ...
        >
          a real-time chat application with machine learning toxicity filtering.
        </motion.p>
        ...
        >
          <p>engineered a real-time chat application incorporating a custom decision engine to instantly monitor, classify, and filter toxic messages using machine learning.</p>
          <p>the backend is powered by flask and sqlite, integrating natural language processing models to classify messages as cyberbullying or clean on-the-fly.</p>
          <p>when a toxic message is detected, cybully\'s decision engine immediately flags and silences the content before it is broadcast to other participants in the chat.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">moderation workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">moderation check</span>
              </div>
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">censor threshold</span>
              </div>

              {/* Step 3: Block Outcome */}
              <div className="flex flex-row flex-nowrap items-center gap-2 md:gap-3 whitespace-nowrap">
