...
const Gator = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-gator`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">go / postgresql / sqlc / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/gator"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/gator</span>
        ...
        >
          a concurrent command-line rss feed aggregator.
        </motion.p>
        ...
        >
          <p>built a concurrent command-line rss feed aggregator to fetch and parse xml feeds, managing user subscriptions and utilizing sqlc for type-safe go and postgresql database queries.</p>
          <p>it implements concurrency patterns in go to process multiple feeds simultaneously, using postgresql for storing feeds, users, and subscriptions.</p>
          <p>using sqlc, the project generates type-safe database queries, guaranteeing compile-time validation for all relational operations.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">aggregator pipeline workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">feed processing</span>
              </div>
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">sqlc compile-time query</span>
              </div>
