...
const Prismo = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-prismo`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">python / gradio / vision ai / elevenlabs / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/ai-medical-vision-bot"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/ai-medical-vision-bot</span>
        ...
        >
          a multimodal ai medical chatbot for voice-activated image diagnosis.
        </motion.p>
        ...
        >
          <p>developed a multimodal ai medical chatbot that analyzes patient medical images and responds to real-time voice queries using elevenlabs audio synthesis and a gradio interface.</p>
          <p>the app integrates state-of-the-art vision-language models with elevenlabs text-to-speech audio synthesis inside a clean gradio interface.</p>
          <p>users can upload medical imagery like x-rays, ask questions vocally, and receive spoken, clinically detailed responses instantly.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">diagnosis voice pipeline</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">audio synthesis</span>
              </div>
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">gradio interface output</span>
              </div>
