...
const SentryProject = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-sentry`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">python / machine learning / sqlite / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/cyber-threat-intelligence-detection-system-ids"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/cyber-threat-intelligence-detection-system-ids</span>
        ...
        >
          an intrusion detection system leveraging isolation forest and voting classifier models.
        </motion.p>
        ...
        >
          <p>built an intrusion detection system leveraging isolation forest and voting classifier ensemble models to identify network anomalies and classify cyber threats.</p>
          <p>it leverages an ensemble of isolation forest and voting classifier models to analyze network traffic patterns and flag suspicious activities.</p>
          <p>the system logs telemetry to a local sqlite database, enabling security analysts to query intrusion logs and adapt classification thresholds.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">ids workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">pattern analysis</span>
              </div>

              {/* Step 2: Isolation & Detection */}
              <div className="flex flex-row flex-nowrap items-center gap-2 md:gap-3 whitespace-nowrap">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">logs propagation</span>
              </div>
