...
const Qupload = ({ layoutSource }: ProjectComponentProps) => {
  const titleLayoutId = `${layoutSource === 'home' ? 'home' : 'list'}-title-qupload`;
      ...
      <div className="w-full max-w-[76rem] h-auto lg:max-h-[85vh] lg:overflow-y-auto lg:no-scrollbar pt-8 lg:pt-0 pb-24 lg:pb-20">
        ...
        <div className="pb-6 mb-8 relative">
          ...
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-3">
            ...
            <span className="text-xs text-muted font-mono">next.js / mongodb / nextauth / imagekit / 2026</span>
          </div>
          ...
          >
            <a
              href="https://github.com/prathamanvekar/video-app"
              target="_blank"
            ...
            >
              ...
              <span>prathamanvekar/video-app</span>
        ...
        >
          a responsive next.js video hosting and streaming platform.
        </motion.p>
        ...
        >
          <p>developed a responsive next.js and mongodb video hosting platform featuring nextauth authentication and a seamless background video upload pipeline directly to imagekit on file selection.</p>
          <p>the platform leverages imagekit\'s video optimization APIs to deliver adaptive streaming, and implements nextauth for secure user authentication.</p>
          <p>optimized upload speeds are achieved by bypassing the main server, allowing direct client-to-cloud uploads with secure ephemeral tokens.</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b border-border/10 bg-border/5">
            <span className="text-[10px] text-muted tracking-wider uppercase font-semibold">streaming upload workflow</span>
          ...
          <div className="p-5 md:p-6 text-muted/95 font-mono select-none overflow-x-auto">
            <div className="flex flex-col gap-4 max-w-3xl min-w-[580px]">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">direct upload</span>
              </div>

              {/* Step 2: Next.js Gateway to Cloud Storage */}
              <div className="flex flex-row flex-nowrap items-center gap-2 md:gap-3 whitespace-nowrap">
              ...
              <div className="flex items-center pl-6 text-muted/30 gap-2">
                ...
                <span className="text-[10px] text-muted/40 uppercase tracking-widest font-semibold">metadata sync</span>
              </div>
